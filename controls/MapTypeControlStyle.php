...
{
    public const DEFAULT_STYLE = 'google.maps.MapTypeControlStyle.DEFAULT';
    public const DROPDOWN_MENU = 'google.maps.MapTypeControlStyle.DROPDOWN_MENU';
    public const HORIZONTAL_BAR = 'google.maps.MapTypeControlStyle.HORIZONTAL_BAR';
